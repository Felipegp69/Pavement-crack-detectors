...
% some sample images.
imds = imageDatastore('Crack Images for Classification','IncludeSubfolders',true, 'LabelSource','foldernames');
...
[imdsTrain,imdsValidation,imdsTest] = splitEachLabel(imds,0.1,0.1,0.1);
